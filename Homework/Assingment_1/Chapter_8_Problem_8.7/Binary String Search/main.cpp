//Juan Enriquez				CSC 5			Chapter 8, P.488 , #7
/*****************************************************************
 *  DISPLAY A LIST OF STRING ARRAYS THAT ARE SORTED
 *________________________________________________________________
 * This program will display a list of string variables inside of
 * array that are sorted.
 *________________________________________________________________
 * INPUT-
 * size :Size if the array
 * names: Array list of names
 * employeeName :User input of a name
 *
 * OUTPUT-
 * results  : The after the search
 ****************************************************************/
